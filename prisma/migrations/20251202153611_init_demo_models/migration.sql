...
ALTER TABLE "demo_patient"
    ADD CONSTRAINT "demo_patient_dentistId_fkey" FOREIGN KEY (
        "dentistId"
    )
        REFERENCES "demo_dentist"(
            "id"
        ) ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "demo_scan"
    ADD CONSTRAINT "demo_scan_dentistId_fkey" FOREIGN KEY (
        "dentistId"
    )
        REFERENCES "demo_dentist"(
            "id"
...
-- AddForeignKey
ALTER TABLE "demo_scan"
    ADD CONSTRAINT "demo_scan_patientId_fkey" FOREIGN KEY (
        "patientId"
    )
        REFERENCES "demo_patient"(
            "id"
        ) ON DELETE SET NULL ON UPDATE CASCADE;