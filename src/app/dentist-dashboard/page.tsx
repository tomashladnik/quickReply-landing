...
export default function DentistDashboard() {
  ...
  // Helper: pick top ML findings to show nicely
      ...
      <header className="bg-white shadow-sm sticky top-0 z-10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex items-center justify-between">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <span className="text-xl font-bold text-gray-900">DentalScan Dashboard</span>
              <span className="px-3 py-1 bg-amber-100 text-amber-800 text-xs font-semibold rounded-full whitespace-now">Not for medical use</span>
            </div>
          </div>
        </div>
      </header>
          ...
          <div className="bg-white rounded-xl shadow-md p-6 border-l-4 border-[#4ebff7]">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-3xl font-bold text-gray-900 mt-2">{dashboardMetrics.totalPatients}</p>
              </div>
              <div className="w-12 h-12 bg-blue-100 rounded-lg flex items-center justify-center">
                <svg className="w-6 h-6 text-[#4ebff7]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="bg-white rounded-xl shadow-md p-6 border-l-4 border-green-500">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-3xl font-bold text-gray-900 mt-2">{dashboardMetrics.linksSent}</p>
              </div>
          ...
          <div className="bg-white rounded-xl shadow-md p-6 border-l-4 border-yellow-500">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-3xl font-bold text-gray-900 mt-2">{dashboardMetrics.pending}</p>
              </div>
          ...
          <div className="bg-white rounded-xl shadow-md p-6 border-l-4 border-purple-500">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-3xl font-bold text-gray-900 mt-2">{dashboardMetrics.completed}</p>
              </div>
        ...
        <div className="bg-white rounded-xl shadow-md p-6">
          ...
          {loadingPatients ? (
            <div className="flex items-center justify-center py-12">
              <svg className="animate-spin h-8 w-8 text-[#4ebff7]" fill="none" viewBox="0 0 24 24">
            ...
            <div className="text-center py-12">
              ...
              <p className="mt-4 text-gray-600">No patients yet. Create your first patient to get started.</p>
            </div>
          ) : (
                ...
                return (
                  ...
                  >
                    ...
                    <div className="flex items-start justify-between mb-4">
                      <div>
                        <h3 className="font-bold text-gray-900 text-lg">{patient.patient_name}</h3>
                    ...
                    {/* AI Analysis Summary */}
                    {patient.status === 'completed' && patient.analysisResult && (() => {
                      ...
                      return (
                        <div className="mt-4 border rounded-lg p-4 bg-blue-50 border-blue-200">
                          <h4 className="text-sm font-semibold text-gray-900 mb-2">
                            AI DentalScan Summary. This is a simulated demo report. Not for medical use.
                          </h4>

                          {/* Overall + quality */}
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-3 text-sm mb-3">
                            <div>
                              <p className="text-gray-600 text-xs">Overall status</p>
                            ...
                            <div>
                              <p className="text-gray-600 text-xs">Image quality</p>
                              <p className="font-semibold text-gray-900">
                          ...
                          <details className="mt-3">
                            <summary className="text-[11px] font-medium text-gray-500 cursor-pointer">
                              Developer details (raw JSON)
                            </summary>
                            <pre className="mt-1 text-[10px] bg-white border border-gray-200 rounded-md p-2 overflow-x-auto">
        ...
        <div className="fixed inset-0 z-50 overflow-y-auto">
          ...
          <div className="flex min-h-full items-center justify-center p-4">
            <div className="relative bg-white rounded-2xl shadow-2xl max-w-md w-full p-8 transform transition-all">
              <h3 className="text-2xl font-bold text-gray-900 mb-6">Patient Profile</h3>
                ...
                <div className="flex gap-3 mt-6">
                  ...
                  <button
                    ...
                    className={`flex-1 py-3 px-6 rounded-lg font-semibold text-white transition-colors ${
                      isSubmitting ? 'bg-gray-400 cursor-not-allowed' : 'bg-[#4ebff7] hover:bg-[#3da8d9]'
                    }`}
                  >
