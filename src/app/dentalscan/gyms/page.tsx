// src/app/dentalscan/gyms/page.tsx
"use client";
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="text-center lg:text-left">
              ...
              <h1 className="text-5xl md:text-6xl font-bold text-gray-900 mb-6 leading-tight">
                DentalScan for{" "}
                <span className="block text-[#4EBFF7]">Gyms & Wellness</span>
              </h1>
              <p className="text-xl text-gray-600 mb-8 leading-relaxed">
                Cosmetic Whitening Awareness for Members
              </p>
              <p className="text-xl text-gray-600 mb-6 leading-relaxed">
                DentalScan is an AI powered tooth whitening assessment tool
                designed for gyms, fitness studios, and wellness centers that
                want to offer a cosmetic, confidence focused experience for
                their members.
              </p>
              <p className="text-lg text-gray-600 mb-8 leading-relaxed">
                This program is built specifically around whitening awareness,
                not medical screening, allowing gyms to add value without
                introducing clinical complexity.
              </p>
                ...
                <div className="p-6">
                  ...
                  <div className="text-center">
                    <p className="text-sm text-gray-600">
                      Members scan QR code → capture tooth photos → receive
                      cosmetic whitening assessment with confidence insights
                    </p>
                  </div>
                </div>
              </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600">
              Confidence, appearance, and self care are core motivations for
              people who invest in fitness and wellness
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
            <div className="bg-white p-6 rounded-xl shadow-lg hover:shadow-xl transition-shadow border border-gray-100">
              ...
              <p className="text-gray-600">
                Many people have no clear way to understand their current tooth
                shade and baseline
              </p>
            </div>
            ...
            <div className="bg-white p-6 rounded-xl shadow-lg hover:shadow-xl transition-shadow border border-gray-100">
              ...
              <p className="text-gray-600">
                Whether whitening may be effective for their specific tooth
                condition and goals
              </p>
            </div>
            ...
            <div className="bg-white p-6 rounded-xl shadow-lg hover:shadow-xl transition-shadow border border-gray-100">
              ...
              <p className="text-gray-600">
                How their results could improve with whitening treatments and
                expected outcomes
              </p>
            </div>
          </div>
          ...
          <div className="bg-linear-to-r from-[#4EBFF7] to-[#35A3E8] rounded-2xl p-8 text-center text-white">
            <div className="max-w-4xl mx-auto">
              <h3 className="text-2xl font-bold mb-6">
                Ideal Wellness Environment
              </h3>
              <p className="text-xl leading-relaxed mb-4">
                Gyms and wellness centers are ideal environments for cosmetic
                awareness, where members are already focused on improving how
                they look and feel.
              </p>
              <p className="text-lg opacity-95">
                DentalScan provides a simple, non invasive way to support that
                experience.
              </p>
            </div>
          </div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600">
              DentalScan enables a fast whitening scan using guided photo
              capture and AI assisted analysis
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
            ...
            <div className="bg-white p-6 rounded-xl shadow-lg hover:shadow-xl transition-shadow border border-gray-100">
              ...
              <p className="text-gray-600">
                Clear whitening score or range with potential improvement
                metrics
              </p>
            </div>
            ...
            <div className="bg-white p-6 rounded-xl shadow-lg hover:shadow-xl transition-shadow border border-gray-100">
              ...
              <p className="text-gray-600">
                Show potential cosmetic improvement visually through clear
                reports
              </p>
            </div>
          ...
          <div className="bg-linear-to-r from-[#4EBFF7] to-[#35A3E8] rounded-2xl p-8 text-center text-white">
            <p className="text-xl font-medium">
              No medical conditions, no disease indicators, and no clinical
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            {[
              {
                ...
                description:
                  "A gym or wellness center offers DentalScan as a cosmetic add on or wellness activation",
              },
              {
                step: "2",
                title: "Member Photo Capture",
                description:
                  "Members complete a guided tooth photo capture using a secure link or QR code",
              },
              {
                step: "3",
                title: "AI Analysis",
                description:
                  "DentalScan analyzes tooth shade and whitening potential using advanced AI",
              },
              {
                step: "4",
                title: "Cosmetic Report",
                description:
                  "Members receive a whitening focused cosmetic report, not a medical report",
              },
              {
                step: "5",
                title: "Independent Choice",
                description:
                  "Members may choose to pursue whitening options independently if they wish",
              },
            ].map((item, index) => (
          ...
          <div className="mt-12 text-center">
            <p className="text-lg font-medium text-gray-900">
              DentalScan does not diagnose, detect disease, or provide medical
              advice.
            </p>
          </div>
        </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-gray-600 mb-8">
                Members receive a comprehensive, positive-focused report that
              ...
              <div className="space-y-6 mb-8">
                <div className="flex items-start">
                  ...
                  <div>
                    <h3 className="text-lg font-semibold text-gray-900 mb-1">
                      Personalized Shade Score
                    </h3>
                    <p className="text-gray-600">
                      Whitening score and current shade assessment
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Before/after visual showing potential whitening results
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Cosmetic-focused recommendations and insights
                    </p>
                  </div>
                </div>
              </div>
              ...
              <ul className="space-y-4">
                <li className="flex items-start">
                  ...
                  <span className="text-gray-700">
                    A cosmetic whitening awareness tool
                  </span>
                </li>
                <li className="flex items-start">
                  <div className="w-6 h-6 bg-green-100 rounded-full flex items-center justify-center mr-4 mt-1 shrink-0">
                  ...
                  <span className="text-gray-700">
                    A confidence focused experience
                  </span>
                </li>
                <li className="flex items-start">
                  <div className="w-6 h-6 bg-green-100 rounded-full flex items-center justify-center mr-4 mt-1 shrink-0">
                  ...
                  <span className="text-gray-700">
                    A value add for premium fitness and wellness brands
                  </span>
                </li>
              </ul>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-linear-to-r from-[#4EBFF7] to-[#35A3E8] rounded-2xl p-8 text-center text-white">
            <h3 className="text-2xl font-bold mb-4">
              Ready to Enhance Member Experience?
            </h3>
            <p className="text-xl mb-8 opacity-95">
              If your organization is exploring ways to enhance member
              experience through cosmetic wellness technology, we would love to
              connect.
            </p>
          ...
          <div className="text-center">
            <div className="mb-6">
              <h3 className="text-2xl font-bold mb-2 text-white">
                DentalScan for Gyms and Wellness Centers
              </h3>
