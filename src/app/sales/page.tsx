...
export default function SalesPage() {
  ...
  const handleSubmit = async (e: FormEvent<HTMLFormElement>) => {
    ...
    if (!response.ok || !data.success) {
      throw new Error(data.error || 'Failed to SMS');
    }
      ...
      alert('Failed to send demo link. Please try again.');
    } finally {
      ...
      <header className="bg-white shadow-sm">
        <div className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8 py-3 sm:py-4">
          <div className="flex items-center gap-2 sm:gap-3 flex-wrap">
            <Image src="/logo.png" alt="ReplyQuick" width={32} height={32} className="shrink-0" />
            <span className="text-base sm:text-xl font-bold text-gray-900 whitespace-nowrap">DentalScan – Demo Dashboard</span>
        ...
        <div className="bg-white rounded-2xl shadow-xl p-5 sm:p-8 md:p-12">
          ...
          <div className="text-center mb-6 sm:mb-8">
            ...
            <p className="text-xs sm:text-sm text-gray-500">
              This demo link can be sent to anyone for evaluation. Not for medical use.
            </p>
          </div>
            ...
            >
              {isSubmitting ? (
                <span className="flex items-center justify-center">
                  ...
                  <span className="text-xs sm:text-base">Sending Demo Link...</span>
                </span>
              ) : (
                'Send Demo Link'
              )}
          ...
          <div className="mt-6 sm:mt-8 pt-6 sm:pt-8 border-t border-gray-200">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4">
              <div className="flex items-start space-x-2">
                ...
                <span className="text-xs sm:text-sm text-gray-600">AI-Powered Analysis</span>
              </div>
              <div className="flex items-start space-x-2">
                <svg 
                  className="w-4 h-4 sm:w-5 sm:h-5 text-green-500 shrink-0 mt-0.5" 
                ...
                <span className="text-xs sm:text-sm text-gray-600">Remote Check-ins</span>
              </div>
              <div className="flex items-start space-x-2">
                <svg 
                  className="w-4 h-4 sm:w-5 sm:h-5 text-green-500 shrink-0 mt-0.5" 
                ...
                <span className="text-xs sm:text-sm text-gray-600">Automated Claims</span>
              </div>
            </div>
            ...
            <div className="relative bg-white rounded-2xl shadow-2xl max-w-md w-full p-6 sm:p-8 transform transition-all">
              ...
              <div className="text-center">
                ...
                <p className="text-lg sm:text-xl font-semibold text-[#4ebff7] mb-3 sm:mb-4">
                  {formData.name || 'the recipient'}
                </p>
                <p className="text-xs sm:text-sm text-gray-600 mb-3 sm:mb-4">
                  This demo link can be used by dentists, investors, or general users.
                </p>
                <div className="bg-blue-50 border border-blue-200 rounded-lg p-3 sm:p-4 mb-3 sm:mb-4">
                  <p className="text-xs sm:text-sm text-gray-700">
                    <span className="font-semibold">Next Steps:</span> They will receive an SMS with a secure link to explore DentalScan features.
                  </p>
                </div>
